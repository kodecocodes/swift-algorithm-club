/*
  A threaded binary tree based on this club's binary search tree implementation.
...
extension ThreadedBinaryTree {
  ...
  */
  ...
  private func removeNodeWithTwoChildren(left: ThreadedBinaryTree, _ right: BinarySearchTree) -> BinarySearchTree {
